...
public class ObliqueClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ClientCommandManager.DISPATCHER.register(ClientCommandManager.literal("inspireme").executes(context ->{
            context.getSource().sendFeedback(new LiteralText(newStrategy()));
            return 1;
        }));
    }
}
